...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = '20230609_webrhinoc_81af59a8b5aa5e766105_20230609092905_archive.zip';
        const ARCHIVE_SIZE       = '47946678';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = '81af59a-09092905';
        const SECONDARY_PACKAGE_HASH = 'd946fb5-09092905';
        const VERSION            = '4.0.6';
