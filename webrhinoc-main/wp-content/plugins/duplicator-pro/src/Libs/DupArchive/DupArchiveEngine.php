...
class DupArchiveEngine extends DupArchive
{
    ...
    public static function addFileFromSrc(
        ...
        if (($archiveHandle = SnapIO::fopen($createState->archivePath, 'r+b')) == false) {
        ...
        if ($forceSize == 0) {
            ...
            // if force size is enables the src isn't compress
    ...
    public static function createArchive($archivePath, $isCompressed)
    {
        ...
        self::addFileFromSrc($archivePath, $src, self::INDEX_FILE_NAME, self::INDEX_FILE_SIZE);
    }
